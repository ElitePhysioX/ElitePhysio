...
var pnm=g(“pnm”); if(pnm) pnm.placeholder=l===“he”?”\u05e7\u05d5\u05e8\u05dc \u05d0\u05d1\u05e8\u05d5\u05d8\u05d9\u05df / Koral Avrutin”:“Koral Avrutin”;
// Header taglines
...
return ‘<div class="card" onclick="op('+p.id+')"><div style="display:flex;align-items:center;justify-content:space-between">’+
‘<div style="display:flex;align-items:center;gap:13px">’+av(p.name)+
‘<div><div class="pat-name">’+p.name+’</div><div class="pat-sub">’+(p.injury||”—”)+’ · ‘+(p.age||”—”)+’</div></div></div>’+
‘<div style="display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end">’+bdg(p.sport)+’ ‘+sbdg(p.status)+’</div></div></div>’;
...
‘<div><div class="pat-name">’+p.name+’</div><div class="pat-sub">’+p.sport+’ · ‘+(p.sessions||0)+’ sessions</div></div></div>’+
...
‘<div style="font-size:13px;color:#4a6a8a;margin-bottom:3px">’+e.sets+’ sets × ‘+e.reps+’</div>’+
...
‘<span style="font-weight:700;font-size:15px;color:#1a3a6e">’+e.name+’</span></div>’+
‘<div style="font-size:13px;color:#4a6a8a;margin-bottom:3px">’+e.sets+’ × ‘+e.reps+’</div>’+
(e.desc?’<div style="font-size:13px;color:#1a2535;margin-bottom:3px">’+e.desc+’</div>’:””)+
(e.tips?’<div style="font-size:13px;color:#00a86b;margin-bottom:8px">💡 ‘+e.tips+’</div>’:””)+
‘<a href="'+ytUrl(e.name)+'" target="_blank" style="font-size:12px;color:#6d28d9;border:1px solid rgba(109,40,217,0.3);border-radius:5px;padding:4px 11px;text-decoration:none;font-weight:600;display:inline-block">’+L().wv+’</a></div>’;
...
‘<div style="font-size:13px;color:#4a6a8a;margin-bottom:18px">’+cur.sport+’ · ‘+(cur.injury||“general”)+’</div>’+
...
window._ail=list;
g(“MC”).innerHTML=’<div style="font-size:16px;font-weight:700;margin-bottom:4px;color:#1a3a6e">’+L().ai+’</div>’+
‘<div style="font-size:13px;color:#4a6a8a;margin-bottom:14px">’+cur.sport+’ · ‘+(cur.injury||“general”)+’</div>’+
...
‘<div style="font-size:13px;color:#4a6a8a;margin-bottom:2px">’+e.sets+’ sets × ‘+e.reps+’</div>’+
...
‘<div style="font-size:10px;color:#4a6a8a;text-transform:uppercase;letter-spacing:1.2px">\u05de\u05db\u05d5\u05df \u05e4\u05d9\u05d6\u05d9\u05d5\u05ea\u05e8\u05e4\u05d9\u05d4 \u05dc\u05e1\u05e4\u05d5\u05e8\u05d8\u05d0\u05d9\u05dd · Yoqneam Ilit</div></div>’+
...
‘<div style="font-size:12px;color:#4a6a8a;margin-bottom:3px">’+e.sets+’ sets × ‘+e.reps+’</div>’+
...
‘\u05e4\u05d9\u05d6\u05d9\u05d5\u05ea\u05e8\u05e4\u05d9\u05d4 \u05dc\u05e1\u05e4\u05d5\u05e8\u05d8\u05d0\u05d9\u05dd \u05e9\u05e8\u05d5\u05e6\u05d9\u05dd \u05dc\u05d4\u05d2\u05d9\u05e2 \u05dc\u05e7\u05e6\u05d4 \u05d4\u05d9\u05db\u05d5\u05dc\u05ea · Yoqneam Ilit<br>Generated: ‘+today+’</div>’+
